...
*****************************************************/
SELECT * FROM EMPLOYEES WHERE LAST_NAME like '%Tucker%';

SELECT salary FROM EMPLOYEES WHERE LAST_NAME LIKE '%Tucker%'; --10000
SELECT E.FIRST_NAME, E.JOB_ID, E.SALARY FROM EMPLOYEES E, (SELECT * FROM EMPLOYEES WHERE LAST_NAME LIKE '%Tucker%') J
...
SELECT E.FIRST_NAME, E.JOB_ID, E.SALARY, E.HIRE_DATE FROM EMPLOYEES E, (SELECT JOB_ID, MAX(SALARY) FROM EMPLOYEES GROUP BY JOB_ID) J
...
SELECT E.LAST_NAME, E.SALARY, E.DEPARTMENT_ID, E.JOB_ID FROM EMPLOYEES E, (SELECT JOB_ID, AVG(SALARY)AS SALARY FROM EMPLOYEES GROUP BY JOB_ID) J
WHERE E.SALARY > J.SALARY;
