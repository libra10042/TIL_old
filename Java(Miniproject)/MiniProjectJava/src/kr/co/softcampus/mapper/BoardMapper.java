...
public interface BoardMapper {
	...
	@Select("select a1.content_idx, a1.content_subject, a2.user_name as content_writer_name, " + 
			" 		to_char(a1.content_date, 'YYY-MM-DD') as content_date " +
	...
	void deletecContentInfo(int content_idx);
	
	
	@Select("select conut(*) from content_table where content_board_idx = #{content_board_idx}")
