...
SELECT '2020-05-20', SYSDATE FROM DUAL;
SELECT '2020-05-20', TO_DATE('2020-05-20', 'YYYY-MM-DD') FROM DUAL;
SELECT '2020-05-20' + 1 FROM DUAL; --ORA-01722: invalid number
SELECT '2020-05-20' || 1 FROM DUAL;
SELECT TO_DATE('2020-05-20', 'YYYY-MM-DD') + 1 FROM DUAL;
SELECT '2020-05-20 14:34:25', 
               TO_DATE('2020-05-20 14:34:25', 'YYYY-MM-DD HH24:MI:SS')
FROM DUAL;       
------------------
